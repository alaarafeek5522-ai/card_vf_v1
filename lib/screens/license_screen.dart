                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      const Icon(Icons.whatsapp_rounded, color: Color(0xFF25D366), size: 20),
                      const SizedBox(width: 8),
                      Text('للحصول على مفتاح تواصل مع المطور',
                        style: GoogleFonts.cairo(color: AppTheme.darkGrey, fontSize: 13)),
                    ]),
